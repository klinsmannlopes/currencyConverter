...
@Service
public class ConverterEUR implements ConverterInterface {

    private final static Logger logger = Logger.getLogger(ConverterEUR.class.getName());
    ...
    public Mono<Transactions> converterAndSave(TransactionInputDTO transactionInputDTO) {
        ...
        double rateUsed = rateDTO.getRates().getEUR();
